...
public:
  ...
  NetConfig & set_link_limit( const unsigned int s_link_limit ) { link_limit = s_link_limit; return *this; }
...
// Simulates the network by calling 'ticks' if network elements
